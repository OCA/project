...
class ProjectTaskMaterials(common.SavepointCase):

    @classmethod
    def setUpClass(cls):
        super(ProjectTaskMaterials, cls).setUpClass()

        cls.task = cls.env.ref('project.project_task_data_0')
        cls.product = cls.env.ref('product.product_product_48')

    def test_create_task_material(self):
        """ Testing creation of task materials """
