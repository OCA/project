...
- The **Update Odoo.sh** button retries the latest successful GitLab CI
  job named ``odoo_sh_deploy`` — the job name is hardcoded, reflecting
  ...
  turning the button into a generic "retry the deploy CI job" action for
