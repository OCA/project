...
class Project(models.Model):
    ...
    parent_id = fields.Many2one(
        related="analytic_account_id.parent_id", readonly=False,
    )
    child_ids = fields.One2many(
        related="analytic_account_id.child_ids", readonly=False,
    )
    ...
    wbs_indent = fields.Char(related="analytic_account_id.wbs_indent", readonly=False,)
    ...
    code = fields.Char(related="analytic_account_id.code", readonly=False,)
    complete_wbs_name = fields.Char(
        related="analytic_account_id.complete_wbs_name", readonly=False,
    )
    ...
    def action_open_child_view(self, module, act_window):
        ...
        child_project_ids = self.env["project.project"].search(
            [("analytic_account_id.parent_id", "=", self.analytic_account_id.id)]
        )
