...
class ProjectTask(models.Model):
    ...
    def action_view_git_branches(self):
        return self._action_view_git_entities(
            "webhook_gitlab.action_git_branch", self.git_branch_ids
        )

    def action_view_git_commits(self):
        return self._action_view_git_entities(
            "webhook_gitlab.action_git_commit", self.git_commit_ids
        )

    def action_view_git_pull_requests(self):
        return self._action_view_git_entities(
            "webhook_gitlab.action_git_pull_request", self.git_pull_request_ids
        )
