...
class contract_contract(osv.osv):
    ...
    def _get_link(self, cr, uid, ids, field_name, arg=None, context=None):
        ...
        for obj in self.browse(cr, uid, ids):
            res[obj.id] = (
                obj.obj_id and obj.type_id.model_id and obj.type_id.model_id.model + ',' + str(obj.obj_id)) or False
        return res
    ...
    def _get_type_id(self, cr, uid, context=None):
        ...
        if context.get('type_id', False):
            ...
            data_ids = model_data.search(
                cr, uid, [('module', '=', module), ('name', '=', name)])
            if data_ids:
