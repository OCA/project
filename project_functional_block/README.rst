...
This module depends on project module.

Configuration
=============

Creating new functional blocks can be done at Project > Functional Blocks > Functional Blocks. Besides, no extra configuration is required.
...
* Go to https://runbot.odoo-community.org/runbot/140/9.0
