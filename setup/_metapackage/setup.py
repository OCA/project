...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-project_forecast_line_bokeh_chart',
        'odoo14-addon-project_forecast_line_deadline',
        'odoo14-addon-project_forecast_line_milestone',
        ...
        'odoo14-addon-project_purchase_link',
        ...
        'odoo14-addon-sale_project_service_tracking_copy_tasks',
    ],
    classifiers=[
