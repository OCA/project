...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-project_required_field_by_stage>=16.0dev,<16.1dev',
        ...
        'odoo-addon-project_status>=16.0dev,<16.1dev',
        ...
        'odoo-addon-project_task_parent_completion_blocking>=16.0dev,<16.1dev',
        'odoo-addon-project_task_parent_due_auto>=16.0dev,<16.1dev',
        ...
        'odoo-addon-project_update_portal>=16.0dev,<16.1dev',
