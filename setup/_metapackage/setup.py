...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo11-addon-project_list',
        'odoo11-addon-project_milestone',
        'odoo11-addon-project_risk',
