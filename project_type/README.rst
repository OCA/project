...
This module provides a project type selection on projects.
...
#. Have Manager rights for Project group to create project types.
#. Go to *Project > Configuration > Project Types*.
#. You have the "Project Type" field available to be set on the project form view.
