...
class ProjectTaskMaterial(models.Model):
    ...
    def _update_unit_amount(self):
        ...
        for sel in self.filtered(
            ...
            and x.stock_move_id.product_id.standard_price
            * x.stock_move_id.product_uom_qty
            * -1
        ):
            sel.analytic_line_id.amount = (
                sel.stock_move_id.product_id.standard_price
                * sel.stock_move_id.product_uom_qty
                * -1
            )
